...
2.	$PSNR (6*PSNR_Y + PSNR_U + PSNR_V)/8$ ![formula](https://render.githubusercontent.com/render/math?math=PSNR (6*PSNR_Y + PSNR_U + PSNR_V)/8) will be used to evaluate the distortion of the decoded pictures.
